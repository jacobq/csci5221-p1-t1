    ...
    render: function() {         
            ...
            return (<div style={this.style_base}>
                        ...
                        <div style={this.style_content}>
                            <input onChange={this.handle_ServerName_Input} style={this.style_input} placeholder="Server Name">{this.state.server_name}</input>
                            <input style={this.style_input} placeholder={this.state.server_name == null ? "Server ID" : this.state.server_name}></input>
                            <input style={this.style_input} placeholder="Server URL/IP Address"></input>
                            <input style={this.style_input} placeholder="Port"></input>
                        </div>
                        <div onClick={this.handle_Submit_OnTouchEnd} style={this.style_button_submit}>
                            <span style={this.style_text}>Submit<span style={this.style_fa}>&#xf058;</span></span>
                        </div>
                    </div>);
    }
});